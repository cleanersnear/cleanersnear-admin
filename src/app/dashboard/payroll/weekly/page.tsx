  ...
  return (
    <main className="min-h-screen px-3 py-6 sm:px-6 sm:py-10 lg:px-10">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 sm:gap-8">
        ...
        {/* Info Card */}
        <div className="rounded-2xl sm:rounded-3xl border border-blue-200 bg-blue-50 p-4 sm:p-6 dark:border-blue-900 dark:bg-blue-950">
          <div className="flex items-start gap-3 sm:gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="mt-2 text-xs sm:text-sm text-blue-800 dark:text-blue-200">
              ...
              <ul className="mt-3 ml-4 list-disc space-y-1 text-xs sm:text-sm text-blue-800 dark:text-blue-200">
              ...
              <p className="mt-3 text-[10px] sm:text-xs text-blue-700 dark:text-blue-300">
            ...
            <div className="divide-y divide-slate-100 dark:divide-slate-800">
              {weeks.map((week) => (
                <Link
                  ...
                  className="block px-4 py-4 sm:px-6 sm:py-5 transition hover:bg-slate-50 dark:hover:bg-slate-950"
                >
                  <div className="flex items-center justify-between gap-3">
                    <div className="flex-1 min-w-0">
                      <p className="text-base sm:text-lg font-semibold text-slate-900 dark:text-slate-100 truncate">
                        {week.weekId}
                      </p>
                    ...
                    <div className="flex items-center gap-2 sm:gap-4 flex-shrink-0">
                      <span className="rounded-full bg-slate-100 px-2 sm:px-3 py-0.5 sm:py-1 text-xs sm:text-sm font-medium text-slate-700 dark:bg-slate-800 dark:text-slate-200">
                        {week.recordCount} emp{week.recordCount !== 1 ? "s" : ""}
                      </span>
