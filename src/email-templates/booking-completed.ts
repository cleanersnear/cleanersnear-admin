...
export interface BookingCompletedData {
  ...
  export function bookingCompletedTemplate(data: BookingCompletedData) {
    return `
      <!DOCTYPE html>
      <html>
      <head>
                      ...
                      <table role="presentation" style="width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                          ...
                          <tr>
                              <td style="padding: 20px 50px; text-align: left;">
                                  ...
                                  <div style="background-color: #ffffff; border-left: 4px solid #2E7D32; padding: 15px; margin-bottom: 15px;">
                                      <h3 style="margin: 0 0 5px 0; color: #1a202c; font-size: 16px;">Refer a Friend</h3>
                                      <p style="margin: 0; color: #4a5568; font-size: 14px;">Refer a friend and both of you will receive 10% off your next service!</p>
                                  </div>
                              </td>
                          </tr>
